...
prerender.shouldShowPrerenderedPage = function(req) {
  ...
  if(prerender.crawlerUserAgents.some(function(crawlerUserAgent){ return ~crawlerUserAgent.toLowerCase().indexOf(userAgent.toLowerCase())})) isRequestingPrerenderedPage = true;
