...
prerender.shouldShowPrerenderedPage = function(req) {
  ...
  if(prerender.crawlerUserAgents.some(function(crawlerUserAgent){ return ~userAgent.toLowerCase().indexOf(crawlerUserAgent.toLowerCase())})) isRequestingPrerenderedPage = true;
